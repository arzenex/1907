...
async function startSystem() {
    ...
    try {
        ...
        const answers = [
            { name: 'RAMU KAKA', destination: 'mcq.html' },
            { name: 'DIVYA', destination: 'divya.html' }
        ];
        ...
        function initPuzzle() {
            ...
            // Unified letter pool for both "DIVYA" and "RAMU KAKA"
            let letterArray = [
                'D', 'I', 'V', 'Y', 'R', 'M', 'U', ' ', 'K', 'K', 'A', 'A', 'A'
            ];
